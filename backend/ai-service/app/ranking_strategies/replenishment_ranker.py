"""Replenishment-oriented ranking strategy — prioritises availability."""
...
WEIGHTS = {"price": 0.2, "brand": 0.2, "availability": 0.6, "merchant": 0.0}


class ReplenishmentRanker(RankingStrategy):
